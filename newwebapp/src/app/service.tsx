...
export default function Service(){
    return (
        <section className="h-full " id="services">
            <div>
                <h1 className="text-center text-2xl font-semibold text-slate-400">MY SERVICES </h1>
            </div>
            <Carousel className="ml-16 w-60 md:hidden">
  <CarouselContent>
    <CarouselItem><div className=" hover:animate-pulse animate-once h-70 w-60 bg-slate-400 rounded-md">
    ...
    <CarouselItem><div className="hover:animate-pulse animate-once h-76 w-60 bg-slate-400 rounded-md">
  ...
  <CarouselNext />
            ...
            <div className="hidden md:flex justify-between items-center h-96 w-full ">
