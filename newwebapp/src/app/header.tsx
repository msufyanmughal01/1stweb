...
function Header(){
    return ( 
    <header className="flex justify-between sticky items-center w-full p-2 bg-transparent" >
        <h1 className=" text-2xl font-bold font-ARIAL text-slate-400">PORTFOLIO</h1>
    <nav>
    <Sheet>
